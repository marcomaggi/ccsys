...
int
ccsys_open (cce_location_t * L, const char *filename, int flags, mode_t mode)
{
#ifdef HAVE_OPEN
  int	rv;
  errno = 0;
...
int
ccsys_openat (cce_location_t * L, int dirfd, const char *filename, int flags, mode_t mode)
{
#ifdef HAVE_OPENAT
  int	rv;
  errno = 0;
...
int
ccsys_close (cce_location_t * L, int filedes)
{
#ifdef HAVE_CLOSE
  int	rv;
  errno = 0;
...
size_t
ccsys_read (cce_location_t * L, int filedes, void * buffer, size_t size)
{
#ifdef HAVE_READ
  ssize_t	rv;
  errno = 0;
...
size_t
ccsys_pread (cce_location_t * L, int filedes, void * buffer, size_t size, off_t offset)
{
#ifdef HAVE_PREAD
  ssize_t	rv;
  errno = 0;
...
size_t
ccsys_write (cce_location_t * L, int filedes, const void *buffer, size_t size)
{
#ifdef HAVE_WRITE
  ssize_t	rv;
  errno = 0;
...
size_t
ccsys_pwrite (cce_location_t * L, int filedes, const void *buffer, size_t size, off_t offset)
{
#ifdef HAVE_PWRITE
  ssize_t	rv;
  errno = 0;
...
off_t
ccsys_lseek (cce_location_t * L, int filedes, off_t offset, int whence)
{
#ifdef HAVE_LSEEK
  off_t		rv;
  errno = 0;
...
size_t
ccsys_readv (cce_location_t * L, int filedes, const struct iovec * vector, int count)
{
#ifdef HAVE_READV
  ssize_t	rv;
  errno = 0;
...
size_t
ccsys_writev (cce_location_t * L, int filedes, const struct iovec * vector, int count)
{
#ifdef HAVE_WRITEV
  ssize_t	rv;
  errno = 0;
